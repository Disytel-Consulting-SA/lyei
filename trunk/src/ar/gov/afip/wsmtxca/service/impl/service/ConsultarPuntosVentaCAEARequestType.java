/**
 * ConsultarPuntosVentaCAEARequestType.java
 *
...
public class ConsultarPuntosVentaCAEARequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarPuntosVentaCAEARequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarPuntosVentaCAEARequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarPuntosVentaCAEARequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarPuntosVentaCAEARequestType)) return false;
        ConsultarPuntosVentaCAEARequestType other = (ConsultarPuntosVentaCAEARequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarPuntosVentaCAEARequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarPuntosVentaCAEARequestType"));
