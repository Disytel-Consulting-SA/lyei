/**
 * ConsultarCondicionesIVARequestType.java
 *
...
public class ConsultarCondicionesIVARequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarCondicionesIVARequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarCondicionesIVARequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarCondicionesIVARequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarCondicionesIVARequestType)) return false;
        ConsultarCondicionesIVARequestType other = (ConsultarCondicionesIVARequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarCondicionesIVARequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarCondicionesIVARequestType"));
