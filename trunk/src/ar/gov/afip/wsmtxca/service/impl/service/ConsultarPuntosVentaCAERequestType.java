/**
 * ConsultarPuntosVentaCAERequestType.java
 *
...
public class ConsultarPuntosVentaCAERequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarPuntosVentaCAERequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarPuntosVentaCAERequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarPuntosVentaCAERequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarPuntosVentaCAERequestType)) return false;
        ConsultarPuntosVentaCAERequestType other = (ConsultarPuntosVentaCAERequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarPuntosVentaCAERequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarPuntosVentaCAERequestType"));
