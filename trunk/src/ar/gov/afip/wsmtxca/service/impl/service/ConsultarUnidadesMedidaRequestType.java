/**
 * ConsultarUnidadesMedidaRequestType.java
 *
...
public class ConsultarUnidadesMedidaRequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarUnidadesMedidaRequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarUnidadesMedidaRequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarUnidadesMedidaRequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarUnidadesMedidaRequestType)) return false;
        ConsultarUnidadesMedidaRequestType other = (ConsultarUnidadesMedidaRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarUnidadesMedidaRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarUnidadesMedidaRequestType"));
