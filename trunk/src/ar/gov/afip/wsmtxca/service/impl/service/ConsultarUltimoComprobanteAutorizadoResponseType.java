/**
 * ConsultarUltimoComprobanteAutorizadoResponseType.java
 *
...
public class ConsultarUltimoComprobanteAutorizadoResponseType  implements java.io.Serializable {
    private java.lang.Long numeroComprobante;
    ...
    public ConsultarUltimoComprobanteAutorizadoResponseType() {
    }

    public ConsultarUltimoComprobanteAutorizadoResponseType(
           java.lang.Long numeroComprobante,
    ...
    /**
     * Gets the numeroComprobante value for this ConsultarUltimoComprobanteAutorizadoResponseType.
     * 
     * @return numeroComprobante
     */
    public java.lang.Long getNumeroComprobante() {
        return numeroComprobante;
    }


    /**
     * Sets the numeroComprobante value for this ConsultarUltimoComprobanteAutorizadoResponseType.
     * 
     * @param numeroComprobante
     */
    public void setNumeroComprobante(java.lang.Long numeroComprobante) {
        this.numeroComprobante = numeroComprobante;
    }


    /**
     * Gets the arrayErrores value for this ConsultarUltimoComprobanteAutorizadoResponseType.
     * 
     * @return arrayErrores
     */
    ...
    /**
     * Sets the arrayErrores value for this ConsultarUltimoComprobanteAutorizadoResponseType.
     * 
     * @param arrayErrores
     */
    ...
    /**
     * Gets the evento value for this ConsultarUltimoComprobanteAutorizadoResponseType.
     * 
     * @return evento
     */
    ...
    /**
     * Sets the evento value for this ConsultarUltimoComprobanteAutorizadoResponseType.
     * 
     * @param evento
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarUltimoComprobanteAutorizadoResponseType)) return false;
        ConsultarUltimoComprobanteAutorizadoResponseType other = (ConsultarUltimoComprobanteAutorizadoResponseType) obj;
        ...
        boolean _equals;
        _equals = true && 
            ((this.numeroComprobante==null && other.getNumeroComprobante()==null) || 
             (this.numeroComprobante!=null &&
              this.numeroComprobante.equals(other.getNumeroComprobante()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getNumeroComprobante() != null) {
            _hashCode += getNumeroComprobante().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarUltimoComprobanteAutorizadoResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarUltimoComprobanteAutorizadoResponseType"));
