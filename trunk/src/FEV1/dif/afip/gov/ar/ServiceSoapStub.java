...
public class ServiceSoapStub extends org.apache.axis.client.Stub implements FEV1.dif.afip.gov.ar.ServiceSoap {
    ...
    public ServiceSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "ArrayOfComprador");
            cachedSerQNames.add(qName);
            cls = FEV1.dif.afip.gov.ar.Comprador[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "Comprador");
            qName2 = new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "Comprador");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());
