/**
 * FEXResponse_Mon_CON_COTIZACION.java
 *
...
public class FEXResponse_Mon_CON_COTIZACION  implements java.io.Serializable {
    private fexv1.dif.afip.gov.ar.ClsFEXResponse_Mon_CON_Cotizacion[] FEXResultGet;

    private fexv1.dif.afip.gov.ar.ClsFEXErr FEXErr;

    private fexv1.dif.afip.gov.ar.ClsFEXEvents FEXEvents;

    public FEXResponse_Mon_CON_COTIZACION() {
    }

    public FEXResponse_Mon_CON_COTIZACION(
           fexv1.dif.afip.gov.ar.ClsFEXResponse_Mon_CON_Cotizacion[] FEXResultGet,
    ...
    /**
     * Gets the FEXResultGet value for this FEXResponse_Mon_CON_COTIZACION.
     * 
     * @return FEXResultGet
     */
    public fexv1.dif.afip.gov.ar.ClsFEXResponse_Mon_CON_Cotizacion[] getFEXResultGet() {
        return FEXResultGet;
    }


    /**
     * Sets the FEXResultGet value for this FEXResponse_Mon_CON_COTIZACION.
     * 
     * @param FEXResultGet
     */
    public void setFEXResultGet(fexv1.dif.afip.gov.ar.ClsFEXResponse_Mon_CON_Cotizacion[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }


    /**
     * Gets the FEXErr value for this FEXResponse_Mon_CON_COTIZACION.
     * 
     * @return FEXErr
     */
    ...
    /**
     * Sets the FEXErr value for this FEXResponse_Mon_CON_COTIZACION.
     * 
     * @param FEXErr
     */
    ...
    /**
     * Gets the FEXEvents value for this FEXResponse_Mon_CON_COTIZACION.
     * 
     * @return FEXEvents
     */
    ...
    /**
     * Sets the FEXEvents value for this FEXResponse_Mon_CON_COTIZACION.
     * 
     * @param FEXEvents
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_Mon_CON_COTIZACION)) return false;
        FEXResponse_Mon_CON_COTIZACION other = (FEXResponse_Mon_CON_COTIZACION) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_Mon_CON_COTIZACION.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Mon_CON_COTIZACION"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Mon_CON_Cotizacion"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Mon_CON_Cotizacion"));
