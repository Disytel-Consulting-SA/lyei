...
public class PersonaReturn  implements java.io.Serializable {
    private sr.puc.server.ws.soap.a5.DatosGenerales datosGenerales;

    private sr.puc.server.ws.soap.a5.DatosMonotributo datosMonotributo;

    private sr.puc.server.ws.soap.a5.DatosRegimenGeneral datosRegimenGeneral;

    private sr.puc.server.ws.soap.a5.ErrorConstancia errorConstancia;

    private sr.puc.server.ws.soap.a5.ErrorMonotributo errorMonotributo;

    private sr.puc.server.ws.soap.a5.ErrorRegimenGeneral errorRegimenGeneral;

    private sr.puc.server.ws.soap.a5.Metadata metadata;

    public PersonaReturn() {
    }

    public PersonaReturn(
           sr.puc.server.ws.soap.a5.DatosGenerales datosGenerales,
           sr.puc.server.ws.soap.a5.DatosMonotributo datosMonotributo,
           sr.puc.server.ws.soap.a5.DatosRegimenGeneral datosRegimenGeneral,
           sr.puc.server.ws.soap.a5.ErrorConstancia errorConstancia,
           sr.puc.server.ws.soap.a5.ErrorMonotributo errorMonotributo,
           sr.puc.server.ws.soap.a5.ErrorRegimenGeneral errorRegimenGeneral,
           sr.puc.server.ws.soap.a5.Metadata metadata) {
     ...
     */
    public sr.puc.server.ws.soap.a5.DatosGenerales getDatosGenerales() {
        return datosGenerales;
    }
     ...
     */
    public void setDatosGenerales(sr.puc.server.ws.soap.a5.DatosGenerales datosGenerales) {
        this.datosGenerales = datosGenerales;
    }
     ...
     */
    public sr.puc.server.ws.soap.a5.DatosMonotributo getDatosMonotributo() {
        return datosMonotributo;
    }
     ...
     */
    public void setDatosMonotributo(sr.puc.server.ws.soap.a5.DatosMonotributo datosMonotributo) {
        this.datosMonotributo = datosMonotributo;
    }
     ...
     */
    public sr.puc.server.ws.soap.a5.DatosRegimenGeneral getDatosRegimenGeneral() {
        return datosRegimenGeneral;
    }
     ...
     */
    public void setDatosRegimenGeneral(sr.puc.server.ws.soap.a5.DatosRegimenGeneral datosRegimenGeneral) {
        this.datosRegimenGeneral = datosRegimenGeneral;
    }
     ...
     */
    public sr.puc.server.ws.soap.a5.ErrorConstancia getErrorConstancia() {
        return errorConstancia;
    }
     ...
     */
    public void setErrorConstancia(sr.puc.server.ws.soap.a5.ErrorConstancia errorConstancia) {
        this.errorConstancia = errorConstancia;
    }
     ...
     */
    public sr.puc.server.ws.soap.a5.ErrorMonotributo getErrorMonotributo() {
        return errorMonotributo;
    }
     ...
     */
    public void setErrorMonotributo(sr.puc.server.ws.soap.a5.ErrorMonotributo errorMonotributo) {
        this.errorMonotributo = errorMonotributo;
    }
     ...
     */
    public sr.puc.server.ws.soap.a5.ErrorRegimenGeneral getErrorRegimenGeneral() {
        return errorRegimenGeneral;
    }
     ...
     */
    public void setErrorRegimenGeneral(sr.puc.server.ws.soap.a5.ErrorRegimenGeneral errorRegimenGeneral) {
        this.errorRegimenGeneral = errorRegimenGeneral;
    }
     ...
     * @return metadata
     */
    public sr.puc.server.ws.soap.a5.Metadata getMetadata() {
        return metadata;
    }
     ...
     * @param metadata
     */
    public void setMetadata(sr.puc.server.ws.soap.a5.Metadata metadata) {
        this.metadata = metadata;
    }
