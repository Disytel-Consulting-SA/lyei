...
public class PersonaServiceA5_ServiceLocator extends org.apache.axis.client.Service implements sr.puc.server.ws.soap.a5.PersonaServiceA5_Service {
    ...
    public sr.puc.server.ws.soap.a5.PersonaServiceA5_PortType getPersonaServiceA5Port() throws javax.xml.rpc.ServiceException {
    ...
    public sr.puc.server.ws.soap.a5.PersonaServiceA5_PortType getPersonaServiceA5Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            sr.puc.server.ws.soap.a5.PersonaServiceA5SoapBindingStub _stub = new sr.puc.server.ws.soap.a5.PersonaServiceA5SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (sr.puc.server.ws.soap.a5.PersonaServiceA5_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                sr.puc.server.ws.soap.a5.PersonaServiceA5SoapBindingStub _stub = new sr.puc.server.ws.soap.a5.PersonaServiceA5SoapBindingStub(new java.net.URL(PersonaServiceA5Port_address), this);
                _stub.setPortName(getPersonaServiceA5PortWSDDServiceName());
                return _stub;
            }
        }
