...
public class ConsultarCAEARequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    private long CAEA;

    public ConsultarCAEARequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarCAEARequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarCAEARequestType.
     * 
     * @param authRequest
     */
    ...
    /**
     * Gets the CAEA value for this ConsultarCAEARequestType.
     * 
     * @return CAEA
     */
    public long getCAEA() {
    ...
    /**
     * Sets the CAEA value for this ConsultarCAEARequestType.
     * 
     * @param CAEA
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarCAEARequestType)) return false;
        ConsultarCAEARequestType other = (ConsultarCAEARequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarCAEARequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarCAEARequestType"));
