/**
 * ConsultarPuntosVentaRequestType.java
 *
...
public class ConsultarPuntosVentaRequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarPuntosVentaRequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarPuntosVentaRequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarPuntosVentaRequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarPuntosVentaRequestType)) return false;
        ConsultarPuntosVentaRequestType other = (ConsultarPuntosVentaRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarPuntosVentaRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarPuntosVentaRequestType"));
