/**
 * ConsultarMonedasRequestType.java
 *
...
public class ConsultarMonedasRequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarMonedasRequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarMonedasRequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarMonedasRequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarMonedasRequestType)) return false;
        ConsultarMonedasRequestType other = (ConsultarMonedasRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarMonedasRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarMonedasRequestType"));
