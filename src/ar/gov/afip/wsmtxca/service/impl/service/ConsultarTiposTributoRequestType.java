/**
 * ConsultarTiposTributoRequestType.java
 *
...
public class ConsultarTiposTributoRequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarTiposTributoRequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarTiposTributoRequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarTiposTributoRequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarTiposTributoRequestType)) return false;
        ConsultarTiposTributoRequestType other = (ConsultarTiposTributoRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarTiposTributoRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarTiposTributoRequestType"));
