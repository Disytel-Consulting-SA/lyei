/**
 * ConsultarTiposDocumentoRequestType.java
 *
...
public class ConsultarTiposDocumentoRequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarTiposDocumentoRequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarTiposDocumentoRequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarTiposDocumentoRequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarTiposDocumentoRequestType)) return false;
        ConsultarTiposDocumentoRequestType other = (ConsultarTiposDocumentoRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarTiposDocumentoRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarTiposDocumentoRequestType"));
