/**
 * ConsultarAlicuotasIVARequestType.java
 *
...
public class ConsultarAlicuotasIVARequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarAlicuotasIVARequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarAlicuotasIVARequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarAlicuotasIVARequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarAlicuotasIVARequestType)) return false;
        ConsultarAlicuotasIVARequestType other = (ConsultarAlicuotasIVARequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarAlicuotasIVARequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarAlicuotasIVARequestType"));
