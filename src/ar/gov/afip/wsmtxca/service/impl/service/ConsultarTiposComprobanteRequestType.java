/**
 * ConsultarTiposComprobanteRequestType.java
 *
...
public class ConsultarTiposComprobanteRequestType  implements java.io.Serializable {
    private ar.gov.afip.wsmtxca.service.impl.service.AuthRequestType authRequest;

    public ConsultarTiposComprobanteRequestType() {
    }
    ...
    /**
     * Gets the authRequest value for this ConsultarTiposComprobanteRequestType.
     * 
     * @return authRequest
     */
    ...
    /**
     * Sets the authRequest value for this ConsultarTiposComprobanteRequestType.
     * 
     * @param authRequest
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarTiposComprobanteRequestType)) return false;
        ConsultarTiposComprobanteRequestType other = (ConsultarTiposComprobanteRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarTiposComprobanteRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.wsmtxca.afip.gov.ar/service/", "ConsultarTiposComprobanteRequestType"));
